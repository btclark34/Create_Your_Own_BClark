...
Next, I create a new dataset, based on the refined dataset, to aid in my exploration and modeling of the data. I begin by creating a null dataset so that I can create x and y subsets within that dataset.
