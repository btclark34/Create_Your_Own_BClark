...
# What proportion of the passengers are satisfied customers? Does it match the original rd dataset?
...
# Let's create the training and test datasets by splitting sat$y and x_scaled matrices into 50% test 
# set and 50% train set.
